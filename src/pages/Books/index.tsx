...
import { ContainerReturnToPage, ReturnToPageIcon, TitleArea, TitleSection } from 'pages/Favorites/styles';
      ...
      <JustifyContainer thereIsHeader >
        ...
        <ListOfCards>
          ...
          {search && searchResult
            ...
            : announcements
            ?.filter((announcement: Announcement) => announcement.category === 'Outros')
            .slice((currentPage - 1) * componentsPerPage, currentPage * componentsPerPage)
            .map((announcement: Announcement, index) => (
              <AnnouncementCard
                key={announcement.id}
